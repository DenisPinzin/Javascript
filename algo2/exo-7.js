/*
2.
Créer un jeux de pierre feuille ciseaux contre l'ordinateur Mettre un message de résumé
du match,
exemple : "l'ia a choisi Pierre, vous avez choisi ciseaux, vous avez perdu"
Faire continuer le match si match nul.
*/
